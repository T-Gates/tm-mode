...
진입 2종(등가 — 둘 다 이 cli.py 로 위임):
  ...
  curl: curl -fsSL https://raw.githubusercontent.com/T-Gates/tm-mode/refs/tags/v0.1.7/install.sh | sh -s -- join <url>
...
# 릴리스마다 __init__.__version__ 과 함께 올린다(maintainer_tests/test_release_pin.py 가 교차 고정).
PIN_REF = "refs/tags/v0.1.7"
