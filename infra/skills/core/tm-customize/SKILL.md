---
name: tm-customize
description: Use when the user wants to customize team banner or util skills. Triggers on "팀색 입히기", "커스텀", "배너 바꿔", "스킬 추가", "스킬 제거", "스킬 추천", "tm-customize".
---

# tm-customize — 팀색 입히기

팀 identity(배너·유틸 스킬)를 입히는 라우터 스킬.
