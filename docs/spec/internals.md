...
The reference build declares six entries in `infra/hooks/manifest.json`. All declared scripts exist under `infra/hooks/`. `auto_pull.py` is a throttle helper and is not a manifest entry.
