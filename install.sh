...
#
#   curl -fsSL https://raw.githubusercontent.com/T-Gates/tm-mode/refs/tags/v0.1.0/install.sh | sh -s -- join <clone-url>
#
...
CLI_URL="${TEAMMODE_CLI_URL:-https://raw.githubusercontent.com/T-Gates/tm-mode/refs/tags/v0.1.0/src/teammode/cli.py}"
