...
#
#   curl -fsSL https://raw.githubusercontent.com/T-Gates/tm-mode/refs/tags/v0.1.5/install.sh | sh -s -- join <clone-url>
#
...
CLI_URL="${TEAMMODE_CLI_URL:-https://raw.githubusercontent.com/T-Gates/tm-mode/refs/tags/v0.1.5/src/teammode/cli.py}"
...
TMP=$(mktemp "${TMPDIR:-/tmp}/tm-mode-cli.XXXXXX")
trap 'rm -f "$TMP"' EXIT
