...
#
#   curl -fsSL https://raw.githubusercontent.com/T-Gates/tm-mode/main/install.sh | sh -s -- join <clone-url>
#
...
CLI_URL="${TEAMMODE_CLI_URL:-https://raw.githubusercontent.com/T-Gates/tm-mode/main/src/teammode/cli.py}"
