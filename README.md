...
> **Without `pip` (curl):** `curl -fsSL https://raw.githubusercontent.com/T-Gates/tm-mode/refs/tags/v0.1.6/install.sh | sh -s -- join <url>` (`init` too).
...
> **`pip` 없이 (curl):** `curl -fsSL https://raw.githubusercontent.com/T-Gates/tm-mode/refs/tags/v0.1.6/install.sh | sh -s -- join <url>` (`init` 도 동일).
